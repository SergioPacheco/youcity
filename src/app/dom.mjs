export function createDom(document) {
  ...
  return {
    ...
    elements: {
      ...
      radioNowPlaying: $("#radio-now-playing"), radioCollapse: $("#radio-collapse"), radioMediaPanel: $("#radio-media-panel"), radioMediaClose: $("#radio-media-close"), radioNowPlayingStatus: $("#radio-now-playing-status"), radioYouTubeSearch: $("#radio-youtube-search"), radioYouTubeResults: $("#radio-youtube-results"), radioYouTubePlayer: $("#radio-youtube-player"),
