export function createDom(document) {
  ...
  return {
    ...
    elements: {
      ...
      connectionQuality: $("#connection-quality"), connectionQualityStatus: $("#connection-quality-status"), connectionQualityDetail: $("#connection-quality-detail"),
      ...
      playerMinimize: $("#player-minimize"), playerRestore: $("#player-restore"), radioSummaryName: $("#radio-summary-name"), mobileVolume: $("#mobile-volume"), radioSummaryPrevious: $("#radio-summary-previous"), radioSummaryNext: $("#radio-summary-next"),
      ...
      radioBrowserDiscover: $("#radio-browser-discover"), radioBrowserPanel: $("#radio-browser-panel"), radioBrowserClose: $("#radio-browser-close"), radioBrowserStatus: $("#radio-browser-status"), radioBrowserResults: $("#radio-browser-results"),
      radioNowPlaying: $("#radio-now-playing"), radioCollapse: $("#radio-collapse"), radioMediaPanel: $("#radio-media-panel"), radioMediaClose: $("#radio-media-close"), radioNowPlayingStatus: $("#radio-now-playing-status"), radioYouTubeResults: $("#radio-youtube-results"), radioYouTubePlayer: $("#radio-youtube-player"),
      ...
      privacySettingsButton: $("#privacy-settings-button"), modeButtons: document.querySelectorAll("[data-mode]"), speedButtons: document.querySelectorAll("[data-speed]"), closeDrawerButtons: document.querySelectorAll("[data-close-drawer]"),
