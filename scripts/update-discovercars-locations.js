...
function writeOutputs(results, source) {
  ...
  mkdirSync(resolve(ROOT_DIR, "src/features/travel"), { recursive: true });
  writeFileSync(resolve(DATA_DIR, "discovercars-locations.json"), `${JSON.stringify(catalog, null, 2)}\n`);
  writeFileSync(resolve(ROOT_DIR, "src/features/travel/discovercars-locations.js"), `// Generated by scripts/update-discovercars-locations.js.\nwindow.YOUCITY_DISCOVERCARS_LOCATIONS = ${JSON.stringify(locations)};\n`);
